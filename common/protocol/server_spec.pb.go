...
var file_common_protocol_server_spec_proto_goTypes = []interface{}{
	(*ServerEndpoint)(nil), // 0: accelerator.core.common.protocol.ServerEndpoint
	(*net.IPOrDomain)(nil), // 1: accelerator.core.common.net.IPOrDomain
	(*User)(nil),           // 2: accelerator.core.common.protocol.User
}
var file_common_protocol_server_spec_proto_depIdxs = []int32{
	1, // 0: accelerator.core.common.protocol.ServerEndpoint.address:type_name -> accelerator.core.common.net.IPOrDomain
	2, // 1: accelerator.core.common.protocol.ServerEndpoint.user:type_name -> accelerator.core.common.protocol.User
