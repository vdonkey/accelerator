...
var file_proxy_vlite_outbound_config_proto_goTypes = []interface{}{
	(*UDPProtocolConfig)(nil), // 0: accelerator.core.proxy.vlite.outbound.UDPProtocolConfig
	(*net.IPOrDomain)(nil),    // 1: accelerator.core.common.net.IPOrDomain
}
var file_proxy_vlite_outbound_config_proto_depIdxs = []int32{
	1, // 0: accelerator.core.proxy.vlite.outbound.UDPProtocolConfig.address:type_name -> accelerator.core.common.net.IPOrDomain
