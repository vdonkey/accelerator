...
var file_proxy_dns_config_proto_goTypes = []interface{}{
	(*Config)(nil),           // 0: accelerator.core.proxy.dns.Config
	(*SimplifiedConfig)(nil), // 1: accelerator.core.proxy.dns.SimplifiedConfig
	(*net.Endpoint)(nil),     // 2: accelerator.core.common.net.Endpoint
}
var file_proxy_dns_config_proto_depIdxs = []int32{
	2, // 0: accelerator.core.proxy.dns.Config.server:type_name -> accelerator.core.common.net.Endpoint
