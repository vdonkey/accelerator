...
var file_proxy_vmess_outbound_config_proto_goTypes = []interface{}{
	(*Config)(nil),                  // 0: accelerator.core.proxy.vmess.outbound.Config
	(*SimplifiedConfig)(nil),        // 1: accelerator.core.proxy.vmess.outbound.SimplifiedConfig
...
var file_proxy_vmess_outbound_config_proto_depIdxs = []int32{
	2, // 0: accelerator.core.proxy.vmess.outbound.Config.Receiver:type_name -> accelerator.core.common.protocol.ServerEndpoint
	3, // 1: accelerator.core.proxy.vmess.outbound.SimplifiedConfig.address:type_name -> accelerator.core.common.net.IPOrDomain
