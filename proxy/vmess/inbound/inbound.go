...
import (
	...
	feature_inbound "github.com/vdonkey/accelerator/v5/features/inbound"
...
func init() {
	...
	isAeadForced := platform.NewEnvFlag("accelerator.vmess.aead.forced").GetValue(func() string { return defaultFlagValue })
