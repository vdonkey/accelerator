...
It is unsupported to use this function to create a context that is suitable to invoke Accelerator's internal component
...
For third party code, usage enabled by creating a context to interact with Accelerator's internal component is unsupported,
